...
\textbf{Project Deadline:} The deadline for project submission is strict, and it's the one reported on the slides. You can submit it anytime after you pass the theoretical exam, up to September 2025 (except if you pass the exam in the last call). No exceptions will be made; no amount of ``please" will be sufficient.
...
\begin{itemize}
    \item Briscola \& Snake : \\\url{alberto.sinigaglia@phd.unipd.it}
    \item Robotics : \\\url{niccolo.turcato@phd.unipd.it}
    \item Autonomous Driving : \\\url{matteo.cederle@phd.unipd.it}
\end{itemize}
Also, add \url{gianantonio.susto@unipd.it} to the receivers.
